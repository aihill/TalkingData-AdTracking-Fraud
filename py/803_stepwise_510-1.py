...
# -*- coding: utf-8 -*-
"""
Created on Thu May 10 12:04:36 2018
...
feature_all = [c for c in feature_all if not (c.startswith('timedelta_') or c.startswith('timedelta2_') or c.startswith('timeDD_'))]
print(f'feature_all {feature_all}')
...
# main
# =============================================================================
use_features = list( set(utils.BEST_FEATURES_506) & set(feature_all) )
...
while True:
    ...
    for feature in feature_all:
        if 'timedeltaV2_' not in feature:
            continue
