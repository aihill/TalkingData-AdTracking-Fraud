...
# -*- coding: utf-8 -*-
"""
Created on Tue May  1 22:31:03 2018
...
dtrain = lgb.Dataset('../data/dtrain_501-3_top30.mt')
gc.collect()
...
sub = pd.read_pickle('../data/sub_501-3.p')
dtest = utils.read_pickles('../data/dtest_501-3_top30')
gc.collect()
